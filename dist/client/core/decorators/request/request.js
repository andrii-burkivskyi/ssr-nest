...
class Request {
    constructor(props) {
        ...
        this.send = async (variables) => {
            ...
            try {
                ...
                return (((_e = (_d = (_c = response) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d.data) === null || _e === void 0 ? void 0 : _e.data) ? response.data.data.data : (_g = (_f = response) === null || _f === void 0 ? void 0 : _f.data) === null || _g === void 0 ? void 0 : _g.data);
            }
            catch (error) {
    ...
    get isLoading() { return this.state === Request.state.LOADING; }
}
