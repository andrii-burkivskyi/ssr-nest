...
export class EntitiesResolver {
  ...
  async entities(
    ...
    return this.entitiesService.findAll(input);
  }
  ...
  async updateEntity(@Args({ name: 'input', type: () => UpdateEntityInput }) input: UpdateEntityInput) {
    ...
    return this.entitiesService.update(input);
  }

  @Mutation(() => Int)
  async deleteEntity(@Args({ name: 'input', type: () => DeleteEntityInput }) input: DeleteEntityInput) {
    return this.entitiesService.delete(input);
  }

  @Mutation(() => [Int])
  async deleteEntities(
    @Args({ name: 'input', type: () => [DeleteEntityInput], defaultValue: [] })
      input: DeleteEntityInput[],
  ) {
    return this.entitiesService.deleteList(input);
  }
}
